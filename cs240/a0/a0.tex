...
\begin{tabular}{ | l || r  | r | c | c |} \hline
  Animal's Name & Avg. Weight & Longevity & Avg. Temperature & Conservation Status  \\ \hline
   ...
   African Elephant & 2300-6400kg & 33 years & 36$^{\circ}$C & Vulnerable \\ \hline
\end{tabular}
...
\begin{figure}
\begin{center}
        \includegraphics[scale=0.5]{african_elephant.jpg}
\end{center}
\caption{\label{figcaption2} African Elephant}
\end{figure}
